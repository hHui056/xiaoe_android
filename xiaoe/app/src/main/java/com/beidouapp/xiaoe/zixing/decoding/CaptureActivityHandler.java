...
package com.beidouapp.xiaoe.zixing.decoding;
...
import com.beidouapp.xiaoe.zixing.view.ViewfinderResultPointCallback;
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            ...
            case R.id.decode_succeeded:
                ...
                TestUtil.showTest("Got decode succeeded message ");
                state = State.SUCCESS;
